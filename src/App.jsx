        ...
        {!squad?(
          ...
          <>
            ...
            <div style={{...B,fontSize:11,color:T.faint,marginTop:10,borderTop:`1px solid ${T.border}`,paddingTop:10}}>
              These are projected squads based on qualifying selections and known form up to early 2026. Official World Cup squads will be announced in May/June 2026. Player ratings are approximate consensus values sourced from EA Sports FC, WhoScored, and Sofascore. They are not an official rating system.
            </div>
          </>
        )}
      </div>
